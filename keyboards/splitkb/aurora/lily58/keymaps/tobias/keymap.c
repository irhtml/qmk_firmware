...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [0] = LAYOUT(
        SE_TILD, KC_1, KC_2, KC_3, KC_4, KC_5,                                       KC_6, KC_7, KC_8, KC_9, KC_0, KC_GRV,
        ...
        KC_1, LSFT(KC_1), LSFT(KC_2), LSFT(KC_3), LSFT(KC_5), LSFT(KC_6),           KC_7, SE_GRV, SE_ACUT, KC_9, KC_0, SE_CIRC,
        KC_TRNS, KC_TRNS, SE_AT, SE_DLR, SE_PERC, SE_ASTR,                            RALT(KC_8), RALT(KC_9), RALT(KC_7), RALT(KC_0), KC_NO, SE_QUOT,
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                    KC_NO, RGB_TOG, KC_0, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD,
